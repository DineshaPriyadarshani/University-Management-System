 ...
 * @author USER
 */
public class SCLectView extends AbstractTableModel {
    
    private static final String [] COLUMN_NAMES = {"LecId","Name","Sub_Code","Email","Tel_No"};
    private static ArrayList<SCLecDetails> list;
    
    SCLectView(ArrayList<SCLecDetails>udList){
            list=udList;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
         switch(columnIndex){
            case 0:return list.get(rowIndex).getLec_Id();
