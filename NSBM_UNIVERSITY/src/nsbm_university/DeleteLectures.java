 ...
 * @author USER
 */
public class DeleteLectures extends javax.swing.JFrame {
    ...
    void setFields(SCLecDetails pd){
        pds=pd;
        jlecid.setText(Integer.toString(pd.getLec_Id()));
        jname.setText(pd.getName());
    ...
    private void initComponents() {
        ...
        jlecid = new javax.swing.JTextField();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jlecid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(dbc.deletesclectures(this.pds)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteLectures.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteLectures().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jlecid;
