...
public class UpdateLectures extends javax.swing.JFrame {
    ...
    void setFields(SCLecDetails pd){
        jlecid.setText(new Integer(pd.getLec_Id()).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SCLecDetails pd=new SCLecDetails();
        pd.setLec_Id(new Integer(jlecid.getText()).intValue());
