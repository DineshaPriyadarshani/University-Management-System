 ...
 * @author USER
 */
public class UCStudentView  extends AbstractTableModel{
    private static final String [] COLUMN_NAMES = {"Std_Id","Full_Name","DOB","Gender","Address","Email","Contact_No"};
    private static ArrayList<UndergraduateDetails> list;
    
    UCStudentView(ArrayList<UndergraduateDetails>udList){
            list=udList;
    }
