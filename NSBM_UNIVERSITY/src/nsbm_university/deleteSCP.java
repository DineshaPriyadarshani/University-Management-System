 ...
 * @author USER
 */
public class deleteSCP extends javax.swing.JFrame {

    /**
     * Creates new form deleteSCP
     */
    DBConection dbc=new DBConection();
    PostgraduateDetails pds;
    public deleteSCP() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed1(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed1
        ...
        if(dbc.deletePStudent(this.pds)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteSCP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
