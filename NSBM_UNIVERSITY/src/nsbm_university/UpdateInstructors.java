 ...
 * @author USER
 */
public class UpdateInstructors extends javax.swing.JFrame {

    DBConection db=new DBConection();
    /**
     * Creates new form UpdateInstructors
     */
    public UpdateInstructors() {
        initComponents();
    }

    void setFields(SCInstructorDetails pd){
        jinstructorid.setText(new Integer(pd.getInstructer_Id()).toString());
        jinstructorname.setText(pd.getName());
        
        jsubcode.setSelectedItem(pd.getSub_Code());
        
        jemail.setText(pd.getEmail());
        jtelno.setText(pd.getTel_No());
    ...
    private void initComponents() {
        ...
        jinstructorid = new javax.swing.JTextField();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jinstructorid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SCInstructorDetails pd=new SCInstructorDetails();
        pd.setInstructer_Id(new Integer(jinstructorid.getText()).intValue());
        pd.setName(jinstructorname.getText());

        pd.setSub_Code(jsubcode.getSelectedItem().toString());
        pd.setEmail(jemail.getText());
        pd.setTel_No(jtelno.getText());

        if(db.updatescinstructors(pd)){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        InstructerSheduleDetails back=new InstructerSheduleDetails();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateInstructors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateInstructors().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jinstructorid;
