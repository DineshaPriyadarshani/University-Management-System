 ...
 * @author USER
 */
public class DeleteInstructors extends javax.swing.JFrame {

    DBConection dbc=new DBConection();
    SCInstructorDetails pds;
    /**
     * Creates new form DeleteInstructors
     */
    public DeleteInstructors() {
        initComponents();
    }

    void setFields(SCInstructorDetails pd){
        pds=pd;
        jinstructorid.setText(Integer.toString(pd.getInstructer_Id()));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(dbc.deletescinstructors(this.pds)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteInstructors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteInstructors().setVisible(true);
            }
        });
    }
