 ...
 * @author USER
 */
public class UCAddStudents extends javax.swing.JFrame {
    DBConection dbcon= new DBConection();
    /**
     * Creates new form UCAddStudents
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UCAddStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UCAddStudents().setVisible(true);
            }
        });
    }
